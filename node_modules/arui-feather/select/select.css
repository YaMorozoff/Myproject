...
.select .select-button {
        ...
        -webkit-transition-property: border-bottom-color, box-shadow, color, width,
            background-color;
...
.select.select_view_filled.select_disabled .select__top,
        .select.select_view_filled.select_disabled .select__placeholder {
...
.select.select_view_filled.select_invalid .select-button.select-button_hovered,
            .select.select_view_filled.select_invalid .select-button.select-button_pressed {
                border-bottom-color: rgba(255, 92, 92, 1);
                box-shadow: inset 0 -1px 0 rgba(255, 92, 92, 1);
            }
